...
function umm_update_user_meta(){
    ...
    $u = (isset($_REQUEST['umm_user']) && !empty($_REQUEST['umm_user']) && $_REQUEST['umm_user'] != 'all') ? sprintf("%d", $_REQUEST['umm_user']) : 'all';
        ...
        case "edit":
           ...
           switch($u){
            case "all":
               ...
               if(($field_settings['unique'] == 'yes' && $all_users) || ($field_settings['unique'] == 'yes' && (umm_is_duplicate($meta_key[0], $meta_value[0]) && $meta_value[0] != ''))):
