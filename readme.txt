...
= 3.5.0 =
Fixed a bug in the Edit Custom Meta function.

= 3.4.9 =
Fixed a bug in the Add Custom Meta function.

= 3.4.8 =
Critical security update.

= 3.4.7 =
Critical security update. All previous versions should be deleted.
